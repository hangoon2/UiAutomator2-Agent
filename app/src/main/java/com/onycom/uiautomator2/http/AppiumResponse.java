...
package com.onycom.uiautomator2.http;
...
import com.onycom.uiautomator2.model.api.server.ErrorModel;
import com.onycom.uiautomator2.model.api.server.ResponseModel;
import com.onycom.uiautomator2.utils.Logger;
import com.onycom.uiautomator2.utils.ModelUtils;
...
import static com.onycom.uiautomator2.utils.ModelUtils.toJsonString;
...
public class AppiumResponse {
    ...
    public void renderTo(IHttpResponse response) {
        ...
        try {
            ...
            final String responseString = ModelUtils.toJsonString(responseModel);
            Logger.info(String.format("AppiumResponse: %s", StringHelpers.abbreviate(responseString, 300)));
