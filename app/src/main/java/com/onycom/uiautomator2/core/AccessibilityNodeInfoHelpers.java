...
import com.onycom.uiautomator2.model.settings.SimpleBoundsCalculation;
...
public class AccessibilityNodeInfoHelpers {
    ...
    public static String getPackageName(@Nullable AccessibilityNodeInfo nodeInfo) {
        return nodeInfo == null ? null : StringHelpers.charSequenceToNullableString(nodeInfo.getPackageName());
    }
