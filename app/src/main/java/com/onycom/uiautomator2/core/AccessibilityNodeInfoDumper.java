...
import com.onycom.uiautomator2.model.UiElement;
import com.onycom.uiautomator2.model.UiElementSnapshot;
import com.onycom.uiautomator2.model.settings.NormalizeTagNames;
...
import com.onycom.uiautomator2.utils.XMLHelpers;
...
//        display.getSize(size);
    ...
    private static String toXmlNodeName(@Nullable String className) {
        ...
        fixedName = XMLHelpers.toNodeName(fixedName);
    ...
    private void serializeUiElement(UiElement<?, ?> uiElement, final int depth) throws IOException {
        ...
        for (Attribute attr : uiElement.attributeKeys()) {
            ...
            serializer.attribute(NAMESPACE, attr.getName(), XMLHelpers.toSafeString(String.valueOf(value), NON_XML_CHAR_REPLACEMENT));
        }
    ...
    private InputStream toStream() throws IOException {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            final UiElement<?, ?> xpathRoot = root == null
                    ? UiElementSnapshot.take(AXWindowHelpers.getCachedWindowRoots(), NotificationListener.getInstance().getToastMessage())
