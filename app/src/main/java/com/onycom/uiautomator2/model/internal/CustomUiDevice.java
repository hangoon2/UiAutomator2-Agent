...
package com.onycom.uiautomator2.model.internal;
...
import com.onycom.uiautomator2.utils.AXWindowHelpers;
...
public class CustomUiDevice {
    ...
    private CustomUiDevice() {
        try {
            ...
            this.METHOD_FIND_MATCH = ReflectionUtils.method(ByMatcherClass, "findMatch", UiDevice.class, BySelector.class, AccessibilityNodeInfo[].class);
            this.METHOD_FIND_MATCHES = ReflectionUtils.method(ByMatcherClass, "findMatches", UiDevice.class, BySelector.class, AccessibilityNodeInfo[].class);
    ...
    public Object findObject(Object selector) throws UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            node = (AccessibilityNodeInfo) ReflectionUtils.invoke(METHOD_FIND_MATCH, ByMatcherClass,
                    Device.getUiDevice(), selector, AXWindowHelpers.getCachedWindowRoots());
    ...
    public List<Object> findObjects(Object selector) throws UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            Object nodes = ReflectionUtils.invoke(METHOD_FIND_MATCHES, ByMatcherClass, Device.getUiDevice(), selector, AXWindowHelpers.getCachedWindowRoots());
