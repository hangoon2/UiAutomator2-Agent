...
import com.onycom.uiautomator2.common.exceptions.StaleElementReferenceException;
import com.onycom.uiautomator2.model.internal.CustomUiDevice;
import com.onycom.uiautomator2.utils.Device;
import com.onycom.uiautomator2.utils.ElementLocationHelpers;
    ...
    private void restoreCachedElement(AndroidElement element) {
        ...
        try {
            if (by instanceof By.ById) {
                String locator = ElementLocationHelpers.rewriteIdLocator((By.ById) by);
                ...
                final NodeInfoList matchedNodes = ElementLocationHelpers.getXPathNodeMatch(
                        by.getElementLocator(), searchRoot, false);
                if (!matchedNodes.isEmpty()) {
                    ui2Object = CustomUiDevice.getInstance().findObject(matchedNodes);
                }
            } else if (by instanceof By.ByAndroidUiAutomator) {
                UiSelector selector = ElementLocationHelpers.toSelector(by.getElementLocator());
                if (selector != null) {
                    ui2Object = searchRoot == null
        ...
        AndroidElement restoredElement = Device.getAndroidElement(element.getId(), ui2Object,
